...
INSERT INTO comments (content, poster, post, likes, date_of_comment)
VALUES ('Burritos are bad.', 1, 2,0, NOW());
...
INSERT INTO users (username, profile_picture, first_name, surname, email_address, friends, blocked, enabled)
VALUES
